    ...
    <S.LandingPageLayout>
      <S.HeaderContainer>
        <S.HeaderBox>
          <S.IntroWrap>
            <h1>
              <span className='info_gradient'>세상의 모든 정보</span>를<br />
            </h1>
            <h1>쉽게 저장하고 관리해 보세요</h1>
          </S.IntroWrap>
          <Link href='./pages/signup.html' className='link_add'>
            링크 추가하기
          </Link>
      ...
      <S.SectionCotainer>
        <S.CardContainer>
          <S.CardBox>
            <h1>
              <span className='link_gradient'>원하는 링크</span>를 저장하세요
            </h1>
        ...
        <S.CardContainer>
          <S.CardBox>
            <h1>
              링크를 폴더로
              <span className='folder_gradient'>관리</span>하세요
            </h1>
        ...
        <S.CardContainer>
          <S.CardBox>
            <h1>
              저장한 링크를
              <span className='share_gradient'>공유</span>해 보세요.
            </h1>
        ...
        <S.CardContainer>
          <S.CardBox>
            <h1>
              저장한 링크를
              <span className='sns_gradient'>검색</span>해 보세요
            </h1>
