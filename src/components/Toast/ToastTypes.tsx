...
export const TOAST_COMPONENTS: Map<ToastType, { text: string; warn: boolean }> =
  new Map<ToastType, { text: string; warn: boolean }>([
    ...
    ["deletePaper", { text: "페이퍼가 삭제되었습니다.", warn: false }],
    ["postPaper", { text: "페이퍼가 추가되었습니다.", warn: false }],
    ["rejectedAddLink", { text: "주소가 올바르지 않습니다.", warn: true }],
    ["nothingValue", { text: "주소를 입력하세요.", warn: true }],
    [
      "emailAlreadyExists",
      { text: "이미 존재하는 이메일 입니다.", warn: true },
    ],
    ["diffrentPassword", { text: "비밀번호를 확인해주세요.", warn: true }],
    ["wrongAccount", { text: "이메일과 비밀번호를 확인해주세요.", warn: true }],
    [
      "wrongPasswordForm",
      { text: "비밀번호는 6자 이상 입력해주세요.", warn: true },
    ],
    [
      "duplicateFolderName",
      { text: "같은 이름의 폴더가 이미 존재합니다.", warn: true },
    ],
    [
      "firstAction",
