      ...
      <S.LandingPageLayout>
        ...
        <S.SectionCotainer>
          <S.CardContainer>
            <S.CardBox>
              <h1>
                <span className='text_gradient link_gradient'>
                  {" "}
                  원하는 링크
                </span>
                를&nbsp;
          ...
          <S.CardContainer>
            <S.CardBox>
              <h1>
                링크를 폴더로
                <S.Break />
                <span className='text_gradient folder_gradient'> 관리</span>
                하세요.
              </h1>
              <p>
          ...
          <S.CardContainer>
            <S.CardBox>
              <h1>
                저장한 링크를
                <S.Break />
                <span className='text_gradient share_gradient'> 공유</span>해
                보세요.
              </h1>
              <p>
          ...
          <S.CardContainer>
            <S.CardBox>
              <h1>
                저장한 링크를
                <S.Break />
                <span className='text_gradient sns_gradient'> 검색</span>해
                보세요.
              </h1>
